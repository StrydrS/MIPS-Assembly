...
.text
	...
	no_swap:
    		...
    		blt $t2, 5, swap_loop    # Loop through inner loop if index < size

    		beqz $t3, end_loop      # Exit outer loop if no swaps occurred
    		j loop                  # Repeat outer loop if swaps occurred
